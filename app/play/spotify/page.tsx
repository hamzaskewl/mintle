...
export default function SpotifyGame() {
  ...
  useEffect(() => {
    const fetchGame = async () => {
      ...
      // if (hasPlayedToday('spotify')) {
      //   const prevScore = getTodayScore('spotify')
      ...
      try {
        const response = await fetch('/api/daily/spotify')
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <motion.div
          ...
          className="w-12 h-12 border-4 border-success border-t-transparent rounded-full"
        />
      </div>
    )
  }
      ...
      <div className="min-h-screen flex items-center justify-center p-6">
        <Card className="max-w-md w-full text-center">
          ...
          <p className="text-text-secondary mb-4">
            You scored <span className="text-success font-bold">{previousScore}/5</span> today
          </p>
    ...
    <div className="min-h-screen flex flex-col p-6">
      ...
      <div className="flex flex-col items-center mb-8 gap-4">
        <div className="flex items-center justify-between w-full">
          ...
          <h1 className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-success via-accent-cyan to-accent-blue">
            MorL
          </h1>
        ...
        <div className="flex items-center gap-3">
          <motion.div
            whileHover={{ scale: 1.02 }}
            className="px-4 py-2 bg-success/20 border-2 border-success rounded-full"
          >
            <span className="text-xl mr-2">🎵</span>
            <span className="font-semibold text-success">Spotify</span>
          </motion.div>
          <Link href="/play/movies">
            <motion.div
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
